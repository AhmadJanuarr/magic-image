...
export const ActionsBar = ({ handleAddImage, handleConvertImage }: ActionsBarProps) => {
  ...
  return (
    <div className="flex justify-between items-center mt-6 bg-white/50 dark:bg-background-dark/50 border border-gray-200 dark:border-gray-700 backdrop-blur-sm rounded-lg p-2">
      <div className="flex items-center gap-2 cursor-pointer hover:text-accent transition-all duration-200 group">
        ...
        <label
          htmlFor="file-upload"
          className="text-sm font-medium text-gray-600 group-hover:text-accent transition-all duration-200 cursor-pointer dark:text-dark-primary"
        >
          Add more images
        </label>
