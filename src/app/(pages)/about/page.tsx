    ...
    <section className="min-h-screen flex items-center justify-center p-8">
      <div className="mx-auto max-w-7xl w-full flex flex-col gap-10">
        <div className="w-full max-w-3xl space-y-14 mx-auto">
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              <p className="text-gray-600 leading-relaxed dark:text-dark-primary">
          ...
          <div className="flex items-center gap-4 border-t border-b border-accent/10 py-6">
            <span className="text-sm font-medium text-gray-600 dark:text-dark-primary">Current Version: </span>
          ...
          <div className="space-y-8">
            ...
            <ul className="grid gap-6">
              <li className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-medium text-gray-800 dark:text-dark-primary">Bulk Image Processing</h3>
                  <p className="text-gray-600 dark:text-dark-primary">
              ...
              <li className="flex items-start gap-4">
                <span className="w-2 h-2 bg-accent rounded-full mt-2"></span>
                <div>
                  <h3 className="font-medium text-gray-800 dark:text-dark-primary">Quality Control</h3>
                  <p className="text-gray-600 dark:text-dark-primary">
              ...
              <li className="flex items-start gap-4">
                <span className="w-2 h-2 bg-accent rounded-full mt-2"></span>
                <div>
                  <h3 className="font-medium text-gray-800 dark:text-dark-primary">Format Flexibility</h3>
                  <p className="text-gray-600 dark:text-dark-primary">
              ...
              <li className="flex items-start gap-4">
                <span className="w-2 h-2 bg-accent rounded-full mt-2"></span>
                <div>
                  <h3 className="font-medium text-gray-800 dark:text-dark-primary ">Privacy-First Approach</h3>
                  <p className="text-gray-600 dark:text-dark-primary">
        ...
        <div className="h-96 bg-accent/20 backdrop-blur-sm p-8 rounded-xl shadow-lg border border-accent/20 justify-center flex flex-col items-center">
          ...
          <p className="text-gray-600 mb-6 dark:text-dark-primary">
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            <input
              ...
              className="flex-1 px-4 py-2 rounded-lg border border-accent/20 focus:outline-none focus:border-accent bg-white/80 dark:bg-background-dark/80 dark:text-dark-primary"
            />
            <button className="px-6 py-2 bg-accent text-white rounded-lg hover:bg-accent/90 transition-all duration-200">
              Subscribe
            </button>
          </div>
          <p className="text-xs text-gray-500 mt-4 dark:text-dark-primary">
